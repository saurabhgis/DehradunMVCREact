...
var MainDist = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:dist' },
...
var StateGovBuildSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:state government office' },
    serverType: 'geoserver'
});
...
var CentralBuildSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:central government buildings' },
    serverType: 'geoserver'
})
...
var DrainageNetSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:drainagenetwork' },
    serverType: 'geoserver'
})
...
var STWCatchmenetBoundSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:stwcatchmentboundry' },
    serverType: 'geoserver'
})
...
var STWPointSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:stwpoint' },
    serverType: 'geoserver'
})
...
var FarmHouseSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:farmhouse' },
    serverType: 'geoserver'
})
...
var ForestSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:forest' },
    serverType: 'geoserver'
})
...
var GreenAreaSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'Dehradun:greenareas' },
    serverType: 'geoserver'
})
...
var AgriSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:agriculture' },
    serverType: 'geoserver'
})
...
var ParkingSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:parking' },
    serverType: 'geoserver',
...
var PetrolPumpSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:petrolpump' },
    serverType: 'geoserver'
})
...
var BridgeAndFlyoverSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:bridgesandflyover' },
    serverType: 'geoserver'
})
...
var TrafficIslandSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:trafficisland' },
    serverType: 'geoserver'
})
...
var TrafficJuncSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:trafficjunction' },
    serverType: 'geoserver'
})
...
var BusDepotSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:busdepot' },
    serverType: 'geoserver'
})
...
var BanksSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:banks' },
    serverType: 'geoserver'
})
...
var PostOffSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:postoffice' },
    serverType: 'geoserver'
})
...
var ATMSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:atms' },
    serverType: 'geoserver'
})
...
var WaterOverheadTankSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'Dehradun:wateroverheadtank' },
    serverType: 'geoserver'
})
...
var WaterTreatmentSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:watertreatmentplant' },
    serverType: 'geoserver'
})
...
var waterLandmarkSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:wateroverheadtanklandmark' },
    serverType: 'geoserver'
})
...
var waterpipSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:waterpipline' },
    serverType: 'geoserver'
})
...
var WaterSupPointSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:watersupplypoint' },
    serverType: 'geoserver'
})
...
var WaterTubeWellSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:watertubewell' },
    serverType: 'geoserver'
})
...
var StreetLightSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:streetlight' },
    serverType: 'geoserver'
})
...
var CommToiletSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:communitytoilet' },
    serverType: 'geoserver'
})
...
var PubToiletSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:publictoilets' },
    serverType: 'geoserver'
})
...
var RailwayLineSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'Dehradun:raillines' },
    serverType: 'geoserver'
})
...
var RailStatSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:railstation' },
    serverType: 'geoserver'
})
...
var FireStatSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:firestation' },
    serverType: 'geoserver'
})
...
var PrimarySource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:primaryschool' },
    serverType: 'geoserver'
})
...
var SWMContSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:swm container' },
    serverType: 'geoserver'
})
...
var SWMTransferSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:swm transfer station' },
    serverType: 'geoserver'
})
...
var bloodbankSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:bloodbank' },
    serverType: 'geoserver'
})
...
var HomeopathicSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:homeopathic' },
    serverType: 'geoserver'
})
...
var MedicalStoreSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:medicalstore' },
    serverType: 'geoserver'
})
...
var ClinicSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:clinics' },
    serverType: 'geoserver'
})
...
var SurgicalSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:surgicalshop' },
    serverType: 'geoserver'
})
...
var VetClinicSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:veterinary' },
    serverType: 'geoserver'
})
...
var HospitalSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'Dehradun:hospitals' },
    serverType: 'geoserver'
})
...
var ABDAreaSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:areabaseddevlopment' },
    serverType: 'geoserver'
})
...
var ABDWardBoundSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:abdwardboundry' },
    serverType: 'geoserver'
})
...
var ABDGreenBuildingSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:abdgreenbuilding' },
    serverType: 'geoserver'
})
...
var ABDMddaParkSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:abdmddapark' },
    serverType: 'geoserver'
})
...
var IsolationwardSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:isolationward' },
    serverType: 'geoserver'
})
...
var OtherEduSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:othereducation' },
    serverType: 'geoserver'
})
...
var SCADATubewellSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:tubewell' },
    serverType: 'geoserver'
})
...
var SCADAReservoirSource = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:reservoir' },
    serverType: 'geoserver'
})
...
var banksforlandmark = new ol.source.TileWMS({
    url: 'http://localhost:8081/geoserver/DehradunGIS/wms',
    params: { 'LAYERS': 'DehradunGIS:bankforlandmark' },
    serverType: 'geoserver'
})
...
function Check1() {
    fetch('http://localhost:8081/geoserver/DehradunGIS/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=DehradunGIS%3Adehracityhospital&maxFeatures=50&outputFormat=application%2Fjson')
        .then(function (res) {
...
//TOURIST ATTRACTION
function Check2() {
    fetch('http://localhost:8081/geoserver/DehradunGIS/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=DehradunGIS%3Atouristforaroundme&maxFeatures=50&outputFormat=application%2Fjson')
        .then(function (res) {
            res.text().then(function (data) {
                // var a = COORDINATE[0];
                // var b = COORDINATE[1];
...
//FUN & ENTERTAINMENT
function Check3() {
    fetch('http://localhost:8081/geoserver/DehradunGIS/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=DehradunGIS%3Afunandentainmentarountme&maxFeatures=50&outputFormat=application%2Fjson')
        .then(function (res) {
            res.text().then(function (data) {
                // var a = COORDINATE[0];
                // var b = COORDINATE[1];
...
document.getElementById("LandmarksGo").addEventListener('click', function () {
    ...
    if (document.getElementById("LandPschool").checked == true) {
        ...
        function Check(Area) {
            fetch('http://localhost:8081/geoserver/DehradunGIS/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=DehradunGIS%3Apschoollandmark&maxFeatures=50&outputFormat=application%2Fjson')
                .then(function (res) {
                    res.text().then(function (data) {
                        //  document.getElementById("LandShow").innerHTML = "";
                        var data = JSON.parse(data);
